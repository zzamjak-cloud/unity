    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 rotatedUV = RotateUV(i.uv, _RotateUV);

                float timeOffset = _Time.y * _WindSpeed * _WindFrequency;
                ...
                float2 centeredUV = rotatedUV - center;
                centeredUV += windOffset;
                centeredUV = centeredUV * (1.0 - windEffect * 0.5);
                centeredUV *= _ImageScale; // 이미지 스케일 적용
                centeredUV += center;
