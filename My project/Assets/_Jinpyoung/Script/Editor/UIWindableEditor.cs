...
[CustomEditor(typeof(UIWindable))]
public class UIWindableEditor : Editor
{
    private UIWindable _targetScript;
    ...
    {
        _targetScript = (UIWindable)target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        // UIWindable 스크립트의 변경사항을 감지합니다.
        if (GUI.changed)
        {
            // 값이 바뀌면 즉시 머티리얼에 반영합니다 (시간은 0으로).
            _targetScript.UpdateMaterialProperties();
        }
