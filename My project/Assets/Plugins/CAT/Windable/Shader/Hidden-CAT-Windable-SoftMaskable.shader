// [OptionalShader] com.coffee.softmask-for-ugui: CAT/Effects/Windable
// mob-sakai SoftMask 대응 Windable 셰이더
Shader "Hidden/CAT/Effects/Windable (SoftMaskable)"
{
    Properties
    {
        [HideInInspector]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // ==== SOFTMASKABLE START ====
                #if SOFTMASKABLE
                col.a *= SoftMask(i.vertex, i.worldPosition, col.a);
                #endif
                // ==== SOFTMASKABLE END ====
