...
namespace CAT.HierarchyUtility
{
    ...
    // UIOrder = 20
    public class PrefabMenuModule : IHierarchyToolModule
    {
        public string ModuleName => "PrefabMenu";
        public int UIOrder => 20;

        private string _targetFolderName = "Presets"; // 찾을 폴더 이름
        private GUIContent _buttonContent;

        public void Initialize(HierarchyWindowAccessor accessor)
        {
            _buttonContent = new GUIContent(" ▼ 프리셋 추가", "지정된 폴더의 프리팹을 생성합니다. (검색 및 스크롤 가능)");
        }
