...
{
#if UNITY_EDITOR
    [CustomEditor(typeof(SoftMaskLight))]
    public class SoftMaskLightEditor : Editor
    {
        ...
        private void OnHierarchyChanged()
        {
            ...
            SoftMaskLight mask = (SoftMaskLight)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            SoftMaskLight softMask = (SoftMaskLight)target;
            ...
            EditorGUILayout.TextField("Shared Material", softMask.MaskedChildCount > 0 ? "Optional Shader (공유)" : "없음");
            ...
            {
                Undo.RecordObject(target, "Reset SoftMaskLight Values");
