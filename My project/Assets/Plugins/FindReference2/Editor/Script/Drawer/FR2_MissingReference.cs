    ...
    internal class FR2_MissingReference : IRefDraw
    {
        ...
        public bool DrawLayout()
        {
            GUILayout.BeginVertical();
            {
                ...
                {
                    if (GUILayout.Button("Scan & Remove Missing Scripts", GUILayout.Height(30)))
                    {
                        StartProcessing();
                    }
        ...
        private void StartProcessing()
        {
            ...
            {
                Debug.LogError($"Error starting processing: {ex.Message}");
        ...
        private void RestoreOriginalScenes()
        {
            ...
            {
                Debug.LogError($"Error restoring original scenes: {ex.Message}");
            }
        }
        ...
        private void ProcessPrefab(string prefabPath)
        {
            ...
            {
                Debug.LogError($"Error processing prefab {prefabPath}: {ex.Message}");
