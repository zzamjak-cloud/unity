...
public interface ICharacterController
{
    ...
    /// <summary>
    /// 현재 이동 입력 값을 반환합니다.
    /// 플레이어는 키보드 입력, 적은 AI 계산 결과를 반환합니다.
    /// </summary>
    ...
    void TriggerSpecialAnimation(CharacterAnimationState animationType);
    
    /// <summary>
    /// 캐릭터가 이동 가능한 상태인지 확인합니다.
    /// </summary>
    ...
    CharacterAnimationState GetCurrentAnimationState();
    ...
    bool IsInAnimationState(CharacterAnimationState state);
}
